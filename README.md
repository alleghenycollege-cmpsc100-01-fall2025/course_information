...
| **11** | Nov 3–7 | <li>**Data Structures II**: [Dictionaries](https://computational-expression.github.io/course_information/week10/dictionaries.html).</li> <li>**Object-Oriented Programming I**: Classes, objects, attributes. Abstraction. </li> | <li> [Activity 8: Git Flow](https://classroom.github.com/a/lhp5eDNy)</li> <li>Lab 8</li> | LO1, LO5; ME (creating expressive computational artifacts). |
