...
| **4** | Sep 15–19 | <li>**Control Flow I**: [Conditionals, Boolean logic](https://computational-expression.github.io/course_information/week03/conditionals.html).</li> <li>**Control Flow II**: Loops, iteration patterns.</li> | <li>[Activity 2: Team Synergy](https://classroom.github.com/a/er4apqcM) (DUE: 10:00am Sep. 17) </li> <li>[Activity 3: Adventure Game Design]() (DUE: 9:00am Sep. 22)</li>  <li>[Lab 2](https://classroom.github.com/a/J9p0Fyv-)</li> <li>Read(optional): [If-else and Control Flow](https://automatetheboringstuff.com/3e/chapter2.html)</li> | LO1; SP (iterative exploration of solutions). |
